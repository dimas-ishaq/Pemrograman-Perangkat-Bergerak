<div class="relative rounded-lg shadow-sm ">
    ...
    <div
        ...
        <h3 class="text-xl font-semibold text-fg-light-heading dark:text-white">
            Add Product
        </h3>
        <button type="button"
            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-fg-light-body rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
    ...
    <form class="max-w-lg mx-auto" method="post" action="{{ route('products.store')  }}" enctype="multipart/form-data">
        ...
        <div class="mb-5 flex items-center space-x-4">
            <div>
                <label for="name" class="block mb-2 text-sm font-medium text-fg-light dark:text-white">Product
                    Name</label>
                <input type="text" id="name" name="name"
                    class="bg-gray-50 border border-gray-300 text-fg-light text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div>
                <label for="stock" class="block mb-2 text-sm font-medium text-fg-light dark:text-white">Stock</label>
            ...
            <div>
                <label for="price" class="block mb-2 text-sm font-medium text-fg-light dark:text-white">Price
                </label>
        ...
        <div class="mb-5 flex items-center space-x-4">
            <div class="w-4/12">
                <label for="category_id" class="block mb-2 text-sm font-medium text-fg-light dark:text-white">
                    Category</label>
            ...
            <div class="w-4/12">
                <label for="status" class="block mb-2 text-sm font-medium text-fg-light dark:text-white">Status</label>
