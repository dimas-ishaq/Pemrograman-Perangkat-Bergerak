 ...
 @if ($profile)
     ...
     <div type="button" data-dropdown-toggle="userDropdown" data-dropdown-placement="bottom-start"
         ...
         <span class="font-medium text-body">{{ strtoupper(substr(auth()->user()->name, 0, 1)) }}</span>
     </div>
 @endif

 <!-- Dropdown menu -->
 <div id="userDropdown"
     class="z-10 hidden bg-white dark:bg-gray-900 dark:text-white border border-default-medium rounded-md shadow-lg w-44">
     ...
     <ul class="p-2 text-sm text-body font-medium" aria-labelledby="avatarButton">
         <li>
             <a href="#"
                 class="block w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded-md">Dashboard</a>
         </li>
         <li>
             <a href="#"
                 class="block w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded-md">Settings</a>
         </li>
         <li>
             <a href="#"
                 class="block w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded-md">Earnings</a>
         </li>
         <li>
             <a href="#" class="block w-full p-2 hover:bg-neutral-tertiary-medium text-fg-danger rounded-md">Sign
                 out</a>
         </li>
     </ul>
 </div>
