<div>
    ...
    <aside id="default-sidebar"
        ...
        aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-green-50 dark:bg-gray-800">
            <div class="w-full flex flex-row justify-start items-center mb-2">
                <img src="{{ asset('images/logo.png') }}" alt="logo-brand" class="w-16 h-16">
                <div class="text-2xl font-bold">NUTRIFY</div>
            </div>
