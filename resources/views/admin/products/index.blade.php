...
@section("content")
    <div class="flex items-center text-sm justify-center w-full transition-opacity opacity-100 duration-750 starting:opacity-0 ">
        {{-- sidebar --}}
        <div class="flex flex-row justify-start items-center mb-4 space-x-2 w-full ">
            ...
            <div class="flex flex-col justify-between items-center w-full space-y-4">
                ...
                <div id="add-product-modal" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                        <!-- Modal content -->
                        @include('components.form-add-product', ['categories' => $categories])
                    </div>
                </div>
